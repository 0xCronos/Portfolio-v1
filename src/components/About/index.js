	...
	return (
		<div className={`${flexWrapCenter} items-center p-8`}>
			...
			<div className='sm:flex-0 2xl:flex-1 2xl:ml-8'>
				<h2 className='text-2xl sm:text-4xl xl:text-5xl tracking-widest text-eastern-blue font-light my-8'>
					Learn more about me
				</h2>
				...
				<a className={`${transition} ${primaryBtn} ${hoverPrimaryBtn} no-underline py-2 px-4`} 
				   href='https://drive.google.com/file/d/1c7iG6cJjMzCwDg4cBzc7MzXV6NxCKzse/view?usp=sharing'
